...
it should be created in a modified Debian ISO environment using Cubic, by first installing the tools required and then 
adding this script
...
The actually functioning of the script was not verified, and was created mostly by an AI agent, so it may contain errors or inaccuracies.
